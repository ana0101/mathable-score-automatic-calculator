def compare_annotations_position_token(filename_predicted,filename_gt,verbose=0):
	...
	if verbose and current_pos_gt != current_pos_p:
		print(current_pos_gt,current_pos_p)
	if verbose and current_token_gt != current_token_p:
		print(current_token_gt,current_token_p)
...
predictions_path_root = "../fisiere_solutie/332_Hodivoianu_Anamaria_antrenare/"
